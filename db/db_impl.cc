...
<<<<<<< HEAD
  ...
  list.push_back(mem_->NewIterator()); //����memtbale�ĵ�����
  mem_->Ref();
  if (imm_ != NULL) {
    list.push_back(imm_->NewIterator());//����immemtbale�ĵ�����
    imm_->Ref();
  }
  versions_->current()->AddIterators(options, &list);//���Լ����Ϊ��������sst�ļ��ĵ�����
=======
  // Collect together all needed child iterators
  std::vector<Iterator*> list;
...
<<<<<<< HEAD
	...
	* port::CondVar cv;
	*};
	*Writer��װWriteBatch����Ҫ�Ƕ����ź���cv���ڶ��̵߳�ͬ�����Լ���batch�Ƿ���ɵı�־done
	*/
	Writer w(&mutex_);
	w.batch = my_batch;
	w.sync = options.sync;
	...
	//ֻ�е�w��λ�ڶ���ͷ����w��û�����ʱ�Ų��õȴ�
	while (!w.done && &w != writers_.front()) {
		w.cv.Wait();
	}
	//���ܸ�w�е�batch�������߳�ͨ�����潲���ĺϲ�����һ�������
	if (w.done) {
		return w.status;
	}
	...
	while (true) {
		//��Ϊ���ǵ�updates���ܺϲ���writers_�����еĺܶ�,��ǰ�߳�����������̵߳�
		//writer��ֻ�軽����Щ�����writer���߳�
		Writer* ready = writers_.front();
		//�Ӷ���ͷ��ȡ������ɵ�writer
		writers_.pop_front();
		if (ready != &w) {
			//���ȡ����writer���ǵ�ǰ�̵߳��Լ��ģ�����writer������̣߳����ѵ��̻߳�ִ
			//�� if (w.done) {
			// return w.status;
			//}�߼�
			ready->status = status;
		...
		//ready == last_writer˵�����Ѿ��Ǻϲ���batch�����һ������ɵ�writer��
		if (ready == last_writer) break;
	}

	// Notify new head of write queue
	if (!writers_.empty()) {
		//���в��գ����Ѷ���ͷ��writer������̣߳��μ����� while (!w.done && &w != writers_.front())
...
<<<<<<< HEAD
	...
	if (size <= (128 << 10)) {
		//�����һ�����ϲ���batch��size��С������Ӧ��С�ϲ���batch���������
		max_size = size + (128 << 10);
	}
	//������Ҫ��¼writers_���������һ�����ϲ���writer����Ϊwrite�����л����߳���Ҫ��
	//������ֹС��batch��Ҫ�ȴ��������ںϲ�
	*last_writer = first;
	...
	for (; iter != writers_.end(); ++iter) {
		...
		if (w->batch != NULL) {
			...
			if (result == first->batch) {
				// ��db���ݳ�Աtmp_batch_��źϲ���Ľ�����൱�ڰѸ������ϲ���writer��
				//������ȫ����������tmp_batch_
				result = tmp_batch_;
